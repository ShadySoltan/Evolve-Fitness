...
export default function Hero() {
    return (
        <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[800px] w-full mx-auto p-4'>
            ...
            <p className='text-sm md:text-base font-light'>I fully embrace the possibility of transforming into a <span className='text-blue-400 font-medium'>powerhouse of strength and size</span> , recognizing the risks of
